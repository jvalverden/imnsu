...
public class decaimientoTDao {

    public static ArrayList<decaimientoTVo> getListadecaimiento(recepciongeneradorVo recepcion) {
        ArrayList<decaimientoTVo> decaimientoArrayList = new ArrayList<decaimientoTVo>();
...
"       fechahora12, dia12, fechahora13, dia13, fechahora14, dia14, idrecepciongenerador FROM radioactividad.decaimientot where idrecepciongenerador=?";
        ResultSet rs = null;
